    ...
    <div className="bg-[#FDFBF7] pt-20">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute top-1/4 right-[6%] hidden lg:block z-10">
          <AnimatedSection direction="right">
            <div className="glass rounded-2xl p-5 border border-[#8B5CF6]/20 animate-floating w-52">
              ...
              <div className="text-[#1A1A1A] text-sm font-semibold">Living Room</div>
              <div className="text-black/40 text-xs mt-1">Luxury Minimal</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {styles.map((s, i) => (
              <AnimatedSection key={s.name} delay={i * 0.1}>
                <div className="group glass rounded-2xl overflow-hidden border border-black/5 hover:border-[#8B5CF6]/20 card-hover h-full">
                  <div className="img-zoom aspect-[4/5] relative">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <h3 className="text-[#1A1A1A] font-display font-bold text-lg group-hover:text-[#C8A97E] transition-colors duration-300">{s.name}</h3>
                    </div>
                  </div>
                  <div className="p-4">
            ...
            {process.map((p, i) => (
              <AnimatedSection key={p.step} delay={i * 0.1}>
                <div className="text-center group">
                  <div className="w-16 h-16 rounded-full glass border border-[#8B5CF6]/20 flex items-center justify-center mx-auto mb-4 group-hover:border-[#C8A97E]/50 transition-all duration-300">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-3xl mx-auto text-center px-4">
          <AnimatedSection>
            <h2 className="text-4xl font-display font-bold text-[#1A1A1A] mb-4">Transform Your <span className="text-gradient-gold">Space Today</span></h2>
            <p className="text-black/50 mb-8">Book a free consultation and let's design your dream interior.</p>
