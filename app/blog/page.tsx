    ...
    <div className="bg-[#16161a] pt-20 min-h-screen">
      ...
      <section className="section-padding pt-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="group relative rounded-3xl overflow-hidden glass-dark border border-white/10 card-hover flex flex-col lg:flex-row">
              ...
              <div className="w-full lg:w-2/5 p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-r from-[#16161a] to-[#1e1e24]">
                ...
                <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4 group-hover:text-[#C8A97E] transition-colors">{featuredPost.title}</h2>
                <p className="text-white/60 mb-8 leading-relaxed">{featuredPost.excerpt}</p>
              ...
              <AnimatedSection key={post.id} delay={i * 0.1}>
                <div className="group h-full flex flex-col cursor-pointer">
                  <div className="relative aspect-video rounded-2xl overflow-hidden img-zoom mb-6">
                    ...
                    <div className="absolute top-4 left-4 px-3 py-1 rounded-full glass-dark text-white text-[10px] uppercase tracking-widest font-bold backdrop-blur-md">
                      {post.category}
                    </div>
                  </div>
                  <div className="flex-1 flex flex-col">
                    <h3 className="text-2xl font-display font-bold text-white mb-3 group-hover:text-[#C8A97E] transition-colors line-clamp-2">
                      {post.title}
                    </h3>
                    <p className="text-white/60 text-sm leading-relaxed mb-6 line-clamp-3 flex-1">
                      {post.excerpt}
                    </p>
                    <div className="flex items-center justify-between text-xs text-white/40 pt-6 border-t border-white/10 mt-auto">
